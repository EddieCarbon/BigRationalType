namespace BigRationalLib
{
    public readonly partial struct BigRational : IConvertible
    {
        ...
        public static explicit operator long(BigRational u) => (long)(u.Numerator / u.Denominator);
        
        // rzutowanie z ułamka na `double`
        public static explicit operator double(BigRational u) => (double)(u.Numerator / u.Denominator);
